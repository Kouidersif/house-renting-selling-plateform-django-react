...
registration_endpoint = "/api/auth/"
...
def test_user_login():
    ...
    response_login = client.post(login_endpoint, login_data)
    assert response_login.status_code == 200
    acesss = response_login.data["access"]
    refresh = response_login.data["refresh"]
    
    assert "access" and "refresh" in response_login.data # Must be True
