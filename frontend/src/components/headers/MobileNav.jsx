...
const MobileNav = ({setShowMobileMenu, showMobileMenu, urls}) => {
    return (
        <>
            ...
            <button onClick={()=> setShowMobileMenu(!showMobileMenu)}><i className="bi bi-list text-3xl"></i></button>

            </div>
            <div className={`fixed left-0 h-screen w-screen z-50 transition-all duration-700 ease-in-out bg-black/90 ${showMobileMenu ? "top-0" : "top-[-100%]"} `}>
