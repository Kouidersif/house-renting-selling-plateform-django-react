...
const NavBar = ({ urls }) => {
    ...
    const { userObj, decodedToken } = useGetAppContext()
            ...
            <header
                ...
                <div className="hidden lg:flex lg:w-[95%] xl:w-[80%] mx-auto h-full justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to={ !userObj?.access && urls.login || urls.userProfile} className="flex items-center gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={20}
                                height={20}
                        ...
                        {
                            userObj?.access && decodedToken?.is_landlord ? 
                            <Link to={urls.createListing} className="cursor-pointer px-6 rounded-full bg-primary text-white hover:bg-white hover:text-primary border-2 border-primary py-3">
                                    Create listing
                            </Link>
                            : null
                        }
                ...
                <MobileNav setShowMobileMenu={setShowMobileMenu}
                    showMobileMenu={showMobileMenu} urls={urls} userObj={userObj} />
