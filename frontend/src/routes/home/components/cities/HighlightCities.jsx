    ...
    return (
        <section className="w-full py-8 lg:py-16 px-4">
            <div className="w-[95%] xl:w-[80%] flex flex-col gap-12 mx-auto">
                ...
                <Link to={""} className={`relative isolate after:opacity-50 after:content-[''] after:w-full after:h-full after:absolute after:bg-black/60 after:rounded-3xl after:bottom-0 after:right-0 after:z-[-1] flex items-end bg-no-repeat bg-center rounded-3xl w-full md:w-[350px] h-[300px] p-4 bg-cover`}
                ...
                <Link to={""} className={`relative isolate after:opacity-50 after:content-[''] after:w-full after:h-full after:absolute after:bg-black/60 after:rounded-3xl after:bottom-0 after:right-0 after:z-[-1] flex items-end bg-no-repeat bg-center rounded-3xl h-[300px] flex-1 p-4 bg-cover`}
